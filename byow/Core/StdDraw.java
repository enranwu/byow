package byow.Core; /******************************************************************************
 *  Compilation:  javac byow.Core.StdDraw.java
 *  Execution:    java byow.Core.StdDraw
 *  Dependencies: none
 *
...
/**
 *  The {@code byow.Core.StdDraw} class provides static methods for creating drawings
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code byow.Core.StdDraw.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdDraw.java">byow.Core.StdDraw.java</a>
 ...
 *           byow.Core.StdDraw.setPenRadius(0.05);
 *           byow.Core.StdDraw.setPenColor(byow.Core.StdDraw.BLUE);
 *           byow.Core.StdDraw.point(0.5, 0.5);
 *           byow.Core.StdDraw.setPenColor(byow.Core.StdDraw.MAGENTA);
 *           byow.Core.StdDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 *  The methods {@code byow.Core.StdDraw.line()} and {@code byow.Core.StdDraw.point()}
 *  draw lines and points; the methods {@code byow.Core.StdDraw.setPenRadius()}
 *  and {@code byow.Core.StdDraw.setPenColor()} control the line thickness and color.
 *  <p>
 ...
 *  and represented in degrees. For example, {@code byow.Core.StdDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *   byow.Core.StdDraw.filledPolygon(x, y);
 *  </pre>
 *  <p>
 *  <b>Pen size.</b>
 ...
 *  </ul>
 *  <p>
 *  For example, {@code byow.Core.StdDraw.setPenRadius(0.025)} makes
 ...
 *  For example, {@code byow.Core.StdDraw.setPenColor(byow.Core.StdDraw.MAGENTA)} sets the
 ...
 *  For example, {@code byow.Core.StdDraw.setCanvasSize(800, 800)}
 ...
 *  leave a small margin, you can call {@code byow.Core.StdDraw.setScale(-.05, 1.05)}.
 *  <p>
 ...
 *   byow.Core.StdDraw.setFont(font);
 *   byow.Core.StdDraw.text(0.5, 0.5, "Hello, World");
 *  </pre>
 *  <p>
 *  <b>Images.</b>
 ...
 *  {@code byow.Core.StdDraw.clear(byow.Core.StdDraw.LIGHT_GRAY)} clears the canvas to a shade
 *  of gray.
 *  <p>
 ...
 *  <pre>
 *   byow.Core.StdDraw.setScale(-2, +2);
 *   byow.Core.StdDraw.enableDoubleBuffering();
 *
 *   for (double t = 0.0; true; t += 0.02) {
 *       double x = Math.sin(t);
 *       double y = Math.cos(t);
 *       byow.Core.StdDraw.clear();
 *       byow.Core.StdDraw.filledCircle(x, y, 0.05);
 *       byow.Core.StdDraw.filledCircle(-x, -y, 0.05);
 *       byow.Core.StdDraw.show();
 *       byow.Core.StdDraw.pause(20);
 *   }
 *  </pre>
 *  <p>
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    ***************************************************************************/
     ...
     * {@code byow.Core.StdDraw.BLACK}, {@code byow.Core.StdDraw.BLUE}, {@code byow.Core.StdDraw.CYAN},
     * {@code byow.Core.StdDraw.DARK_GRAY}, {@code byow.Core.StdDraw.GRAY}, {@code byow.Core.StdDraw.GREEN},
     * {@code byow.Core.StdDraw.LIGHT_GRAY}, {@code byow.Core.StdDraw.MAGENTA}, {@code byow.Core.StdDraw.ORANGE},
     * {@code byow.Core.StdDraw.PINK}, {@code byow.Core.StdDraw.RED}, {@code byow.Core.StdDraw.WHITE}, and
     * {@code byow.Core.StdDraw.YELLOW}.
     *
    ...
    ***************************************************************************/
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to byow.Core.StdDraw)
        if (icon.getImageLoadStatus() != MediaTracker.COMPLETE) {
...
/*
    private static BufferedImage getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to byow.Core.StdDraw)
        try {
            URL url = byow.Core.StdDraw.class.getResource(filename);
            BufferedImage image = ImageIO.read(url);
            return image;
        }
        catch (IOException e) {
